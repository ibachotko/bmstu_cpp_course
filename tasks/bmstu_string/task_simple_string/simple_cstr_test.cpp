...
// {
// 	bmstu::wstring a_str(L"abc💧💧💧💧💧ZOV");

// 	std::ofstream file("eggplant.txt");
// 	file << a_str;
// 	file.close();

// 	bmstu::wstring read_str;
// 	std::ifstream infile("eggplant.txt");
// 	infile >> read_str;

// 	ASSERT_STREQ(read_str.c_str(), L"abc💧💧💧💧💧ZOV");
// }